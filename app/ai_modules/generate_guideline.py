...
import requests
from config import OPENAI_API_KEY,AIRTABLE_API_KEY,AIRTABLE_BASE_ID,PERPLEXITY_API_KEY,PINECONE_API_KEY,PINECONE_ENVIRONMENT
import pinecone
from openai import OpenAI
import json
        ...
        try:
            ...
            response = client.chat.completions.create(
                ...
                messages=[
                    {
                        "role": "system",
                        "content": "You are a helpful assistant that generates search terms as a plain text"
                    },
                    {
                        "role": "user",
                        "content": prompt
