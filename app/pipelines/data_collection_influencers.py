...
APIFY_API_TOKEN = "apify_api_OzlpdlQM48B0bXW6gKThLiVYz5nIcS35jGvl"
...
def data_collection(instagram_username,influencer_type,influencer_location):
    ...
    record_exists = unique_key_check_airtable('instagram_url',instagram_data["instagram_url"],"src_influencer_data")
    if not record_exists:
        print(f"Record doesn't exist")
        export_to_airtable(instagram_data,"src_influencer_data")
    else:
